...
export default function EventsLanding({
  ...
  return (
    <div
      className={`relative h-screen flex-col items-cetner ${
        showMenuBackground ? "bg-green-500" : ""
      }`}
    >
      <div
        className={`absolute top-0 left-0 z-10 flex items-center justify-between w-full h-20 px-5 ${
      ...
      >
        ...
        <div className="flex items-center">
          <NavLink to="/">
            <img src={disruptLogo} alt="testLogo" className="w-16 mt-4 ml-4" />
          </NavLink>
        </div>
        ...
        <div className="relative z-0 flex flex-col items-center justify-center h-full">
          ...
          >
            ...
            >
              ...
              workshops, and guest panels to give Northeastern skills and
              insight into the FinTech industry to show how impactful FinTech
              can be. These events are open to everyone at Northeastern and no
              signup is require ahead of time.
            </p>
          </div>
        </div>
      )}
